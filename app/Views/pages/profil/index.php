            ...
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('profil') ?>">Profil Anda</a></li>
                            <li class="breadcrumb-item active">Pandeka Setan</li>
                        </ol>
                    </div>
                    <!--end col-->
                </div>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-8">
                            <input class="form-control" type="text" value="Pandeka Setan" autocomplete="off">
                            <span class="form-text text-muted font-12">Isilah nama sesuai dengan nama di KTP anda!</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-8">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="1234567890123456" maxlength="16" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-8">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" autocomplete="off" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-8">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="ridhalyz@apps.ipb.ac.id" aria-describedby="basic-addon1" disabled=disabled>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
