            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title">Tambah Jenis Vaksin</h4>
                        </div>
                        <!--end col-->
                    </div>
                    <!--end row-->
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-8">
                            <input class="form-control" type="text" placeholder="Kode Vaksin" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">Nama Vaksin</label>
                        <div class="col-lg-9 col-xl-8">
                            <input class="form-control" type="text" placeholder="Nama Vaksin" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
